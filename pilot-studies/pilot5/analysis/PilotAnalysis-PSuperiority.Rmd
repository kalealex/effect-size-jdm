...
<!-- ```{r} -->
<!-- model_df %>% -->
<!--   group_by(lo_ground_truth, means, sd_diff, condition, start_means) %>%  -->
<!--   summarise( -->
<!--     n_workers = length(unique(worker_id)), -->
<!--     n = n() -->
<!--   ) -->
...
Let's look at our prior predictive distribution. For this intercept model, it should be skewwed left because we have located our prior near 74%. We should see a peak near the upper bound of the probability scale.
